    ...
    try {
      ...
      if (result?.error) {
        if (result.error.includes("verify your email")) {
          setError(
            "Please verify your email before logging in. A verification code was sent to your inbox."
          );
        } else {
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-muted-foreground mt-1.5">
            Sign in to access your curated journeys and saved itineraries
          </p>
        </div>
          ...
          <CardContent className="p-6 sm:p-8">
                    ...
                    <div className="flex-1">
                      ...
                      {error.includes("verify your email") && (
                        <Link
                          ...
                          className="font-medium underline mt-1 inline-block hover:opacity-80"
                        >
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <Button
                ...
                className="w-full h-11 rounded-full bg-primary hover:bg-primary-hover text-primary-foreground font-bold shadow-md shadow-primary/25 hover:shadow-lg transition-all cursor-pointer"
              >
                {isLoading ? (
                  <>
